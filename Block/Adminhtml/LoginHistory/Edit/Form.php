 ...
 */
namespace TrellisChallenge\Security\Block\Adminhtml\Loginlog\Edit;
...
/**
 * Class Form
 * @package TrellisChallenge\Security\Block\Adminhtml\LoginlHistory\Edit
 */
class Form extends Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $log = $this->_coreRegistry->registry('login_history');
